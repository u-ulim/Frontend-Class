...
// Callback 함수 중 가운데 어떤 요소라도 1개만 에러가 발생되는 경우, 연결되ㅇ어있는 다른 callback 함수 실행에도 영향을 미친다.

// 그런데, 만약 callback 함수가 많이 연결되어있는 경우에는 어떤 callback함수에서 에러가 발생되었는지 서칭 && 디버깅하기가 매우 힘들다!
